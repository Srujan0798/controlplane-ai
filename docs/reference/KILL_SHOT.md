...
| "40 ms p95." | "**≤40 ms p50 / ≤200 ms p95 targets.** Measured gate: see `submission/latency_bench.json` (n=10000)." |
...
- Hostile Q&A drill (room defense): `docs/reference/QA.md`
- Runbook (stand): `docs/JUDGE_RUNBOOK.md` — Never-say table
- Latency bench (measured): `submission/latency_bench.json`
