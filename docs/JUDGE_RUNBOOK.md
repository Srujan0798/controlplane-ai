...
Full hostile Q&A: [QA.md](reference/QA.md). Drill sheet (one-liners + curls): [HOSTILE_QA_DRILL.md](HOSTILE_QA_DRILL.md). Architecture freezes: [ARCHITECTURE.md](ARCHITECTURE.md) §5, §10.
...
When the human is ready (not automatic). Match this section:
